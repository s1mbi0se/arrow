...
std::vector<NativeFunction> GetDateTimeArithmeticFunctionRegistry() {
  static std::vector<NativeFunction> datetime_fn_registry_ = {
      ...
      NativeFunction("add", {}, DataTypeVector{date64(), day_time_interval()},
                     timestamp(), kResultNullIfNull, "add_day_time_interval_date64"),
      NativeFunction("add", {}, DataTypeVector{timestamp(), day_time_interval()},
                     timestamp(), kResultNullIfNull, "add_day_time_interval_timestamp"),
      NativeFunction("add", {}, DataTypeVector{date64(), month_interval()}, timestamp(),
      ...
      NativeFunction("subtract", {}, DataTypeVector{date64(), day_time_interval()},
                     timestamp(), kResultNullIfNull, "subtract_day_time_interval_date64"),
      ...
      NativeFunction("subtract", {}, DataTypeVector{date64(), month_interval()},
                     timestamp(), kResultNullIfNull,
                     "subtract_year_month_interval_date64"),
