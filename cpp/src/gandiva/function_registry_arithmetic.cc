...
std::vector<NativeFunction> GetArithmeticFunctionRegistry() {
  static std::vector<NativeFunction> arithmetic_fn_registry_ = {
      ...
      UNARY_SAFE_NULL_IF_NULL(istrue, ({"is true", "isnotfalse", "is not false"}), boolean, boolean),
      UNARY_SAFE_NULL_IF_NULL(isfalse, ({"is false", "isnottrue", "is not true"}), boolean, boolean),
      UNARY_SAFE_NULL_IF_NULL(istrue, ({"is true", "isnotfalse", "is not false"}), int32, boolean),
      UNARY_SAFE_NULL_IF_NULL(isfalse, ({"is false", "isnottrue", "is not true"}), int32, boolean),
      UNARY_SAFE_NULL_IF_NULL(istrue, ({"is true", "isnotfalse", "is not false"}), int64, boolean),
      UNARY_SAFE_NULL_IF_NULL(isfalse, ({"is false", "isnottrue", "is not true"}), int64, boolean),
      UNARY_SAFE_NULL_IF_NULL(istrue, ({"is true", "isnotfalse", "is not false"}), float32, boolean),
      UNARY_SAFE_NULL_IF_NULL(isfalse, ({"is false", "isnottrue", "is not true"}), float32, boolean),
      UNARY_SAFE_NULL_IF_NULL(istrue, ({"is true", "isnotfalse", "is not false"}), float64, boolean),
      UNARY_SAFE_NULL_IF_NULL(isfalse, ({"is false", "isnottrue", "is not true"}), float64, boolean),
