...
class GANDIVA_EXPORT IntervalHolder : public FunctionHolder {
 ...
 protected:
  ...
  void return_error(ExecutionContext* context, const std::string& data) const {
...
class GANDIVA_EXPORT IntervalDaysHolder : public IntervalHolder<IntervalDaysHolder> {
 public:
  ...
  int64_t operator()(ExecutionContext* ctx, const std::string& data, bool in_valid,
                     bool* out_valid);
 ...
 private:
  ...
  /// a string
  static int64_t GetIntervalDayFromMillis(const std::string& number_as_string,
                                          bool* out_valid);

  /// Retrieves the day interval from the number of weeks enconded as
  /// a string.
  static int64_t GetIntervalDayFromWeeks(const std::string& number_as_string,
                                         bool* out_valid);

  static int64_t GetIntervalDayFromCompletePeriod(const std::string& days_in_period,
                                                  const std::string& hours_in_period,
                                                  const std::string& minutes_in_period,
                                                  const std::string& seconds_in_period,
                                                  bool* out_valid);
};
...
class GANDIVA_EXPORT IntervalYearsHolder : public IntervalHolder<IntervalYearsHolder> {
 public:
  ...
  /// Cast a generic string to an interval
  int32_t operator()(ExecutionContext* ctx, const std::string& data, bool in_valid,
                     bool* out_valid);
 ...
 private:
  static int32_t GetIntervalYearFromNumber(const std::string& number_as_string,
                                           bool* out_valid);

  static int32_t GetIntervalYearFromCompletePeriod(const std::string& yrs_in_period,
                                                   const std::string& months_in_period,
                                                   bool* out_valid);
};
}  // namespace gandiva
