...
TEST_P(TestProjectorParametrizedFixture, TestBase64) {
  // schema for input fields
...
TEST_P(TestProjectorParametrizedFixture, TestUnbase64) {
  // schema for input fields
  auto field0 = field("f0", arrow::utf8());
  auto schema = arrow::schema({field0});
...
TEST_P(TestProjectorParametrizedFixture, TestBinRepresentation) {
  // schema for input fields
  auto field0 = field("f0", arrow::int64());
  auto schema = arrow::schema({field0});
